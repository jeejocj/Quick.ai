      ...
      <div className="max-w-6xl mx-auto flex flex-wrap gap-6">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs uppercase tracking-widest text-blue-300/80">Background Removal</p>
              <h1 className="text-2xl font-semibold">Clean up visuals effortlessly</h1>
            </div>
          </div>
        ...
        <div className="flex-1 min-w-[280px] bg-gray-900/70 backdrop-blur-2xl border border-white/10 rounded-2xl p-6 flex flex-col shadow-[0_20px_80px_-40px_rgba(0,0,0,0.8)] max-h-[600px]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs uppercase tracking-widest text-cyan-300/80">Output</p>
